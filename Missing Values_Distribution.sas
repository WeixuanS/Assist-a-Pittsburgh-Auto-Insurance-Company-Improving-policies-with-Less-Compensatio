...
* Host: heinz-s18-049;
* Project Path: C:\Users\weixuans\Documents\My SAS Files;
* Project Name: intersection;
* Diagram Id: EMWS1;
* Diagram Name: intersection;
* Generated by: weixuans;
* Date: 02MAR2019:16:44:16;
*------------------------------------------------------------*;
*------------------------------------------------------------*;
* Macro Variables;
*------------------------------------------------------------*;
...
%let EM_PROJECTNAME =;
%let EM_WSNAME =;
%let EM_WSDESCRIPTION =intersection;
